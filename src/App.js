...
import {HomeFilled, SettingFilled, DropboxSquareFilled, SmileFilled, ProjectFilled, UserOutlined, TeamOutlined} from "@ant-design/icons";
      ...
      <div className={"bottomnavWrapper"}>
        <center>
          <div className="bottomnav">
            ...
            <button type="button" className="btn btn-link" onClick={navigateAssets}><div style={{display: "flex", flexDirection: "column"}}><DropboxSquareFilled /><p className="nav-labels" >Assets</p></div></button>
            <button type="button" className="btn btn-link" onClick={navigateExperts}><div style={{display: "flex", flexDirection: "column"}}><TeamOutlined /><p className="nav-labels" >Experts</p></div></button>
